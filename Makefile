...
#am__append_2 = libipq
DIST_COMMON = $(am__configure_deps) $(am__dist_conf_DATA_DIST) \
...
RECURSIVE_TARGETS = all-recursive check-recursive dvi-recursive \
	...
	uninstall-recursive
am__dist_conf_DATA_DIST = etc/ethertypes
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = libiptc libxtables include libipq utils extensions \
	iptables
...
ACLOCAL = ${SHELL} /home/haizhi/download/iptables_igt/iptables-20160826/build-aux/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/haizhi/download/iptables_igt/iptables-20160826/build-aux/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/haizhi/download/iptables_igt/iptables-20160826/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/haizhi/download/iptables_igt/iptables-20160826/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/haizhi/download/iptables_igt/iptables-20160826/build-aux/missing --run automake-1.9
AWK = gawk
CC = gcc
...
ENABLE_BPFC_FALSE = 
ENABLE_BPFC_TRUE = #
ENABLE_CONNLABEL_FALSE = #
ENABLE_CONNLABEL_TRUE = 
ENABLE_DEVEL_FALSE = #
ENABLE_DEVEL_TRUE = 
ENABLE_IPV4_FALSE = #
ENABLE_IPV4_TRUE = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/haizhi/download/iptables_igt/iptables-20160826/build-aux/missing --run makeinfo
OBJEXT = o
PACKAGE = iptables
PACKAGE_BUGREPORT = 
...
blacklist_4_modules = 
blacklist_6_modules = 
blacklist_a_modules =  mangle
blacklist_b_modules =  limit mark nflog mangle
blacklist_modules =  ipvs connlabel
blacklist_x_modules = 
...
infodir = ${prefix}/info
install_sh = /home/haizhi/download/iptables_igt/iptables-20160826/build-aux/install-sh
kbuilddir = 
kinclude_CPPFLAGS = 
ksourcedir = 
...
prefix = /home/haizhi/download/iptables_igt/iptables-20160826/tmp_install
...
SUBDIRS = libiptc libxtables $(am__append_1) $(am__append_2) utils \
	extensions iptables
#confdir = $(sysconfdir)
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/build-aux $(distdir)/etc $(distdir)/extensions $(distdir)/include $(distdir)/include/iptables $(distdir)/iptables $(distdir)/libipq $(distdir)/libiptc $(distdir)/m4
